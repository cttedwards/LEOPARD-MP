...
par(bg = NA) 
#par(bg = "white") 
pdf(file = '/Users/RossTyzackPitman/Documents/OneDrive/Data/GitHub/Databases/PhD_Chapter3/MSE_Paper/figures/Extinction.Prob.Model.2.pdf', 
    width = 8, height = 5)
boxplot(x.tot,
...
par(bg = NA) 
#par(bg = "white") 
pdf(file = '/Users/RossTyzackPitman/Documents/OneDrive/Data/GitHub/Databases/PhD_Chapter3/MSE_Paper/figures/Population.Size.Model.2.pdf', 
    width = 8, height = 5)
boxplot(x.tot,
