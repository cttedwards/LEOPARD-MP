...
param <- c(S.1   = surv.diff.c[2] * (1/surv.diff.c[1]),       # cub
           ...
           br.36 = 1.53,                               # birth rate (mother 36-48)     
           br.48 = 1.53,                               # birth rate (mother 48-60)              
           br.60 = 1.53,                               # birth rate (mother 60-72)               
           br.72 = 1.53,                               # birth rate (mother 72-84)               
           br.84 = 1.53,                               # birth rate (mother >84)                
...
maternal.effects <- c(S.1.1 = (surv.diff.c[2] * (1/surv.diff.c[1])),
                      S.1.2 = (surv.diff.c[2] * (1/surv.diff.c[1])),
                      S.1.3 = (surv.diff.c[2] * (1/surv.diff.c[1])),
                      S.1.4 = (surv.diff.c[2] * (1/surv.diff.c[1])),
                      S.1.5 = (surv.diff.c[2] * (1/surv.diff.c[1])),
                      S.2.1 = (surv.diff.j[2] * (1/surv.diff.j[1])),
                      S.2.2 = (surv.diff.j[2] * (1/surv.diff.j[1])),
                      S.2.3 = (surv.diff.j[2] * (1/surv.diff.j[1])),
                      S.2.4 = (surv.diff.j[2] * (1/surv.diff.j[1])),
                      S.2.5 = (surv.diff.j[2] * (1/surv.diff.j[1])))
