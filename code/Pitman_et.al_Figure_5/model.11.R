...
par(bg = NA) 
#par(bg = "white") 
cairo_pdf(file = '/Users/RossTyzackPitman/Documents/OneDrive/Data/GitHub/Databases/PhD_Chapter3/MSE_Paper/figures/Population.Size.Model.11.pdf', 
          width = 8, height = 5)
boxplot(x.tot[,11:nyr.proj],
        ...
        ylim = c(0,10000),
        outline = FALSE)
title("Hunting = 100% males \u2265 7 yrs; Aging error = 9%;\n Illegal killing or problem animal control = 1%", line = -3)
axis(side = 1, at = 1:nyr.proj)
dev.off()

par(bg = NA) 
#par(bg = "white") 
pdf(file = '/Users/RossTyzackPitman/Documents/OneDrive/Data/GitHub/Databases/PhD_Chapter3/MSE_Paper/figures/Eigen.Value.Model.11.pdf', 
    width = 8, height = 5)
